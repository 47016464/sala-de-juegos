...
export class SupabaseService {
  ...
  async guardarMonkeyJump(
    ...
    if (error) {
      ...
      console.error(
        'Error guardando partida Monkey Jump:',
        error
      );
...
async obtenerEncuestas() {
  ...
  async usuarioYaRespondioEncuesta(
  usuario: string
) {
